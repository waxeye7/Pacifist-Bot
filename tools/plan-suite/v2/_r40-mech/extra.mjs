/**
 * r40 extra: parkCap rooms, hubDistCap / maxHubDist hist, takeTowerSwap.
...
console.log(JSON.stringify({ park, hub, maxHub, swaps: swaps.length, swapRooms: swaps.map((s) => s.room), radii, stub }, null, 2));
