/**
 * Round-34 fleet-wide remaining META_DARK presence flips + per-name singles.
 * p12 moved stitched/stitchTiles/roadsEaten/towerOnly/stubRoads to derived.
 * Fleet-zero minus baseCut+shallowNow (and those five). Never writes the artifact.
 */
import fs from "fs";
