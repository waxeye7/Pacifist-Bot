...
}
{
  ...
  if (lapR) await rec(run("p21 baseLap := 0", lapR.room, (p) => { p.meta.misc.mobilityVeto.baseLap = 0; }));
  if (lapR) await rec(run("p21 baseLap += 1", lapR.room, (p) => { p.meta.misc.mobilityVeto.baseLap += 1; }));
  if (labsR) await rec(run("p21 labs.baseLap := 0", labsR.room, (p) => { p.meta.labs.lapVeto.baseLap = 0; }));
  if (labsR) await rec(run("p21 labs.baseLap += 1", labsR.room, (p) => { p.meta.labs.lapVeto.baseLap += 1; }));
...
{
  await rec(run("p22 E11S7 towers.baseLap := 0", "E11S7", (p) => { p.meta.towers.mobilityVeto.baseLap = 0; }));
  await rec(run("p22 E11S7 towers.baseLap += 1", "E11S7", (p) => { p.meta.towers.mobilityVeto.baseLap += 1; }));
...
const extra = ["E11S1", "E2S7", "E1S4", "E11S7"];
