/**
 * r44 leftover: p22 towers.baseLap walk + other copies + presence skip kinds.
...
console.log(JSON.stringify({
  ...
  tw0N,
  fleetTw0: { pass: fleetTw0.pass, fail: fleetTw0.fail, first: fleetTw0.firstFails },
  tw1N,
  fleetTw1: { pass: fleetTw1.pass, fail: fleetTw1.fail, first: fleetTw1.firstFails },
}, null, 2));
