/**
 * Slim r43 fleet: leftover presence counts + p21/p20/p19 named + leftover doors.
...
console.log(JSON.stringify({
  ...
  bogN,
  fleetBog: { pass: fleetBog.pass, fail: fleetBog.fail, first: fleetBog.firstFails.slice(0, 3) },
  wasN,
  fleetWas: { pass: fleetWas.pass, fail: fleetWas.fail, first: fleetWas.firstFails.slice(0, 3) },
  lapN,
  fleetLap: { pass: fleetLap.pass, fail: fleetLap.fail, first: fleetLap.firstFails.slice(0, 3) },
  lapPlusN,
  fleetLapPlus: { pass: fleetLapPlus.pass, fail: fleetLapPlus.fail, first: fleetLapPlus.firstFails.slice(0, 3) },
  labsLapN,
  fleetLabsLap: { pass: fleetLabsLap.pass, fail: fleetLabsLap.fail, first: fleetLabsLap.firstFails.slice(0, 3) },
  nkLapN,
  fleetNkLap: { pass: fleetNkLap.pass, fail: fleetNkLap.fail, first: fleetNkLap.firstFails.slice(0, 3) },
  twLapN,
  fleetTwLap: { pass: fleetTwLap.pass, fail: fleetTwLap.fail, first: fleetTwLap.firstFails.slice(0, 3) },
  ms: out.ms,
}, null, 2));
