/**
 * Round-35 hostile mutations. In-memory checkRoom only. Never writes the artifact.
 * Named BITES re-probes: p13 mineralContainer / minDmgPicked / servedFree / stitched 0/1;
 * p12 five leftover walks; 88 leaky+complete=false; 98 one-copy 19,27.
