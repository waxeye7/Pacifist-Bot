/**
 * Round-31 mechanical review helpers. Throwaway. Never writes the artifact.
 */
import fs from "fs";
...
export const EXPECTED_MD5 = "86d38bdd2b2aef39a79cb8aa134f9b06";
...
export function roomHash(room) {
  return fmix32(fnv1a32("round31-mech|" + room));
}
