/**
 * Round-42 hostile mutations. In-memory checkRoom only. Never writes the artifact.
 * Named BITES re-probes: p20 baseOverGated / wasLap; p19 takeTowerSwap.from
 * other D8 / unreachedClusters / unreachableExts / servedExts; p18 maxHubDist
 * / from→1,1; p17 stubCap 43↔51 / floorUngated / radii / parkCap /
 * takeTowerSwap.to; p16 hubDistCap/lapCeilingFloor/corridorPlaced; seedScore;
