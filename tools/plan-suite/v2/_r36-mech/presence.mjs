/**
 * Round-36 fleet-wide remaining META_DARK presence flips + per-name singles.
 ...
 * Fleet-zero minus baseCut+shallowNow+all derived. Never writes the artifact.
 */
import fs from "fs";
...
const NEWLY_DERIVED = [...P12_DERIVED, ...P13_DERIVED, ...P14_DERIVED];
