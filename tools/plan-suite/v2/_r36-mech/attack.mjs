/**
 * Round-36 hostile mutations. In-memory checkRoom only. Never writes the artifact.
 * Named BITES re-probes: p14 nine leftover presence names; p13 / p12; 88 leaky+complete=false; 98 one-copy.
 * ESCAPE class: 98 both-lists, wanted+=1, 88 same-lap, remaining presence, seedScore, protectRadius enum.
 */
import fs from "fs";
