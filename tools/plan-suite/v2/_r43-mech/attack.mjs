/**
 * Round-43 hostile mutations. In-memory checkRoom only. Never writes the artifact.
 * Named BITES re-probes: p21 baseLap (veto + labs.lapVeto); p20 baseOverGated
 * / wasLap; p19 takeTowerSwap.from other D8 / unreachedClusters /
 * unreachableExts / servedExts; p18 maxHubDist / from→1,1; p17 stubCap
 * 43↔51 / floorUngated / radii / parkCap / takeTowerSwap.to; p16
 * hubDistCap/lapCeilingFloor/corridorPlaced; seedScore; p15–p12;
 * 88 leaky+complete=false; 98 one-copy.
