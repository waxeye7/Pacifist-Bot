/**
 * Round-43 mechanical review helpers. Throwaway. Never writes the artifact.
 */
import fs from "fs";
...
export const EXPECTED_MD5 = "8e5d6725885bd3f3731379bedf408326";
...
export function roomHash(room) {
  return fmix32(fnv1a32("round43-mech|" + room));
}
