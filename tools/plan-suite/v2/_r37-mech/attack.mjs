/**
 * Round-37 hostile mutations. In-memory checkRoom only. Never writes the artifact.
 * Named BITES re-probes: seedScore :=0 / +=999; p15 ten; p14 nine; p13; p12;
 * 88 leaky+complete=false; 98 one-copy.
 * ESCAPE class: 98 both-lists, wanted+=1, 88 same-lap, remaining presence,
 * protectRadius enum.
 */
import fs from "fs";
