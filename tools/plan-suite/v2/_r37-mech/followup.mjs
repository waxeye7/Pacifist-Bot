/**
 * Round-37 twin-identity follow-up on leftover single-room BITES. Never writes the artifact.
 */
import fs from "fs";
...
// p15 leftover: fleet-zero remaining presence minus derived+baseCut+shallowNow+hubDistCap.
// p15 bound deepReach to hubDistCap, so zeroing hubDistCap alone now fails the formula.
{
