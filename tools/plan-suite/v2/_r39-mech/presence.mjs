/**
 * Round-39 fleet-wide remaining META_DARK presence flips + per-name singles.
...
const NEWLY_DERIVED = [...P12_DERIVED, ...P13_DERIVED, ...P14_DERIVED, ...P15_TEN, ...P16_FOUR, ...P17_FIVE];
