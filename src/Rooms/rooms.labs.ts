function labs(room) {
    ...
    if(!room.memory.labs.status.lab1Input || !room.memory.labs.status.lab2Input || !room.memory.labs.status.currentOutput || Game.time % 750 == 0) {
        ...
        else if(storage && storage.store[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] < 6000) {
                lab1Input = RESOURCE_CATALYST;
        ...
        else if(storage && storage.store[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] < 6000) {
        ...
        else if(storage && storage.store[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] < 6000) {
                lab1Input = RESOURCE_CATALYST;
        ...
        else if(storage && storage.store[RESOURCE_CATALYZED_UTRIUM_ACID] < 6000) {
                lab1Input = RESOURCE_CATALYST;
        ...
        else if(storage && storage.store[RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE] < 11000) {
                lab1Input = RESOURCE_CATALYST;
