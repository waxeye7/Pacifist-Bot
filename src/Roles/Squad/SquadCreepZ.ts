 ...
 const run = function (creep:any) {
    ...
    if(squad.length == 4) {
        ...
        a.fatigue == 0 && b.fatigue == 0 && y.fatigue == 0 && z.fatigue == 0) {
            ...
            // else if(b.pos.x > creep.pos.x && creep.pos.x > move_location.x) {
            //     creep.moveTo(b);
            // }
            if(a.pos.x > creep.pos.x && creep.pos.x > move_location.x ||
                a.pos.x < creep.pos.x && creep.pos.x < move_location.x) {
                creep.moveTo(a);
            }
            // else if(b.pos.y < creep.pos.y && creep.pos.y > move_location.y && creep.pos.x == move_location.x ||
            //     a.pos.y > creep.pos.y && creep.pos.y < move_location.y && creep.pos.x == move_location.x) {
            //         creep.moveTo(a);
            //     }
            else {
